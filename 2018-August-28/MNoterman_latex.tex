...
% nice use of present tense and starting out broad to capture a wide audience with
...
in their lives {[}3{]}.
% is pathophysiology jargon? Perhaps biological underpinnings instead?
% should psychiatric be Neuropsychiatric to stay focused on the topic being covered?
...
{[}18, 19{]}.  
% uneeded relisting of the neuropsychiatric disorders?
% disease versus disorder? Are they synomyms? what's the impact for each?
...
% psychopathology a different word or a synomym?
...
% how does this paragraph relate to neuropsychiatric disease?
% connect the hippocampus in the previous paragraph?
...
% connect the renal tubular cells to the brain somehow?
...
% perhaps explain the (proposed) connection between impairments of oxidative phosphorylation
